...
public class ApprovalPayload {
  ...
  // public static final String TRAVEL_REQ_WSDL = "http://oaosoatst-wls-1.sub08071802371.oandopaasvcn.oraclevcn.com:9073/soa-infra/services/default/IntroductionLetterApproval/bpelprocess1_client_ep?WSDL";
  //  public static final String TRAVEL_REQ_WSDL ="https://oaosoatest.oandoplc.com/soa-infra/services/default/IntroductionLetterApproval/bpelprocess1_client_ep?WSDL";
   ...
   /***Cloud purpose un comment these section while deploying to PROD cloud **/    
    ...
    public static String businessTypeXMLData(String p_EmployeeName,String p_EmployeeNumber,String p_travelReq,String p_Country,String p_Email,String p_travelPurposeCode,String p_BusinessGroup,String p_Remarks,String p_UserName,ArrayList p_Relationship, ArrayList p_FullName, ArrayList p_DateOfBirth,
        ...
        "         <app:UserName>"+p_UserName+"</app:UserName>\n" +
